...
import AuthenticationSwitch from '@/Components/AuthenticationSwitch.vue';
...
const submit = () => {
    codeForm.post(route('check-code'), {
        onSuccess: () => form.post(route('register'), {
...
<template>
    ...
    <AuthenticationCard>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="mt-4">
                <InputLabel for="code" value="Invitation Code" />
                <TextInput id="code" v-model="codeForm.code" type="text" class="block w-full mt-1" required autofocus
                    autocomplete="code" />
